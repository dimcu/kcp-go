...
func ListenWithOptionsTurn(conn net.PacketConn, block BlockCrypt, dataShards, parityShards int) (*Listener, error) {
...
func DialWithOptionsTurn( raddr string,conn net.PacketConn, block BlockCrypt, dataShards, parityShards int) (*UDPSession, error) {
